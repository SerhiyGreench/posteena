...
const Toolbar = ({ editor }: ToolbarProps): ReactElement | null => {
    ...
    return (
        <div className="supports-backdrop-filter:bg-muted/40 bg-muted/50 sticky top-0 z-10 flex w-full flex-wrap items-center gap-1 rounded-t-md border-b p-1 backdrop-blur-sm">
