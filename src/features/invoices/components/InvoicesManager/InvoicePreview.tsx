...
export default function InvoicePreview({
    ...
    return (
        <div
            className="mx-auto w-full max-w-3xl rounded-lg p-6 text-[13px] leading-snug shadow-sm"
            style={{
        ...
        >
            ...
            <div className="flex items-start justify-between gap-6">
                ...
                <div className="text-right">
                    <div className="text-[11px]" style={{ color: Paper.muted }}>
                        {model.numberLabel}
                    </div>
                    ...
                    >
                        {group.map(field => (
                            <div key={field.label} className="contents">
                                ...
                                <dd className={field.strong ? 'font-bold' : ''}>
                                    {field.value}
                                </dd>
                            </div>
                        ))}
            ...
            <div className="overflow-x-auto">
                <table className="w-full table-fixed border-collapse">
                    ...
                    <thead>
                        <tr style={{ borderBottom: `1px solid ${Paper.ink}` }}>
                            {model.items.headers.map((lines, index) => (
                                <th
                                    ...
                                    style={{
                                        color: Paper.muted,
                                        textAlign: model.items.aligns[index],
                                    }}
                                >
                                    {lines.map(line => (
            ...
            <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <p
                    className="max-w-sm text-[12px] italic"
                    style={{ color: Paper.muted }}
                >
